...
public class ListaOre {
    ...
    public boolean add(OraGraph d) {
        OraGraph o = get(d.giorno, d.spazio);
        if ( o == null) {
            listaOre.add(d);
    ...
    public void remove(OraGraph d) {
        listaOre.remove(d);
        scrollList.remove(d.toString());
        d = null;
    }

    public OraGraph get(int g, int s) {
        int i;
        boolean trovato = false;
        OraGraph o = null;
        for (i = 0; i < listaOre.size() && !trovato; i++) {
            o = (OraGraph) listaOre.get(i);
            if ((o.giorno == g) &&
                (o.spazio == s))
                trovato = true;
        }
 ...
 *
    ...
    private void init1A(Classe cl, Aula a, ListaMaterieDocenti materieDocenti) {
        ...
        o = new OraGraph(1, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(1, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        o = new OraGraph(1, 3, classe, d, mLab, aLab, cLab);
        o.docenti.add(dLab);
        updateListeOre(o, d, dLab, a);
        o = new OraGraph(1, 4, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        o = new OraGraph(1, 5, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        o = new OraGraph(1, 6, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        ...
        o = new OraGraph(2, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(2, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(2, 3, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(2, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        oColl = new OraGraph(2, 5, classe, d, m, a, c);
        updateListeOre(oColl, d, null, a);
        o.setSucc(oColl);
        oColl.setPrec(o);
        o = new OraGraph(2, 6, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o.setPrec(oColl);
        oColl.setSucc(o);
        ...
        o = new OraGraph(3, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(3, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(3, 3, classe, d, mLab, aLab, cLab);
        o.docenti.add(dLab);
        ...
        o = new OraGraph(3, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(3, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(3, 6, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        o = new OraGraph(4, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        oColl = new OraGraph(4, 2, classe, d, m, a, c);
        updateListeOre(oColl, d, null, a);
        o.setSucc(oColl);
        oColl.setPrec(o);
        ...
        o = new OraGraph(4, 3, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        oColl = new OraGraph(4, 4, classe, d, m, a, c);
        updateListeOre(oColl, d, null, a);
        o.setSucc(oColl);
        oColl.setPrec(o);
        o = new OraGraph(4, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(4, 6, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        o = new OraGraph(5, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(5, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        o = new OraGraph(5, 3, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(5, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        o = new OraGraph(5, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(5, 6, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        ...
        o = new OraGraph(6, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(6, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(6, 3, classe, d, mLab, aLab, cLab);
        o.docenti.add(dLab);
        updateListeOre(o, d, dLab, aLab);
        ...
        o = new OraGraph(6, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(6, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(6, 6, classe, d, mLab, aLab, cLab);
    ...
    private void init1B(Classe cl, Aula a, ListaMaterieDocenti materieDocenti) {
        ...
        o = new OraGraph(1, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(1, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(1, 6, classe, d, mLab, aLab, cLab);
        updateListeOre(o, d, null, aLab);
        ...
        o = new OraGraph(2, 3, classe, d, mLab, aLab, cLab);
        o.docenti.add(dLab);
        updateListeOre(o, d, dLab, a);
        o = new OraGraph(2, 4, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        o = new OraGraph(2, 5, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        o = new OraGraph(2, 6, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
        ...
        o = new OraGraph(3, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(3, 3, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(3, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        c           = materieDocenti.getMateriaColor("Storia, Cittadinanza e Costituzione");
        m           = materieDocenti.getMateria("Storia, Cittadinanza e Costituzione");
        oColl = new OraGraph(3, 5, classe, d, m, a, c);
        updateListeOre(oColl, d, null, a);
        o.setSucc(oColl);
        oColl.setPrec(o);
        o = new OraGraph(3, 6, classe, d, m, a, c);
        ...
        o = new OraGraph(4, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(4, 2, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(4, 3, classe, d, mLab, aLab, cLab);
        o.docenti.add(dLab);
        updateListeOre(o, d, dLab, aLab);
        ...
        m           = materieDocenti.getMateria("Lingua Inglese");
        d           = materieDocenti.getDocente("Borgonovo Alessandra");
        o = new OraGraph(4, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(4, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(4, 6, classe, d, m, a, c);
        ...
        o = new OraGraph(5, 1, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        oColl = new OraGraph(5, 2, classe, d, m, a, c);
        updateListeOre(oColl, d, null, a);
        o.setSucc(oColl);
        oColl.setPrec(o);
        ...
        o = new OraGraph(5, 3, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        oColl = new OraGraph(5, 4, classe, d, m, a, c);
        updateListeOre(oColl, d, null, a);
        o.setSucc(oColl);
        oColl.setPrec(o);
        o = new OraGraph(5, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(5, 6, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        m           = materieDocenti.getMateria("Scienze integrate (Scienze della Terra e Biologia)");
        d           = materieDocenti.getDocente("Rossi Paolo");
        o = new OraGraph(6, 3, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(6, 4, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        ...
        o = new OraGraph(6, 5, classe, d, m, a, c);
        updateListeOre(o, d, null, a);
        o = new OraGraph(6, 6, classe, GestOrarioApplet.d0, GestOrarioApplet.m0,
                GestOrarioApplet.a0, GestOrarioApplet.c0);
        updateListeOre(o, null, null, null);
    }
 * @param o
